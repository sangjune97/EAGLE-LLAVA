...
python -m model_vqa_eagle \
    ...
    --ea-model-path /home/sangjun/EAGLE-LLAVA/ckpt/not_finetune_w_img_1e-4_no_noise/state_20 \
    ...
    --answers-file /home/sangjun/EAGLE-LLAVA/ckpt/not_finetune_w_img_1e-4_no_noise/state_20/mmvet.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
    --token-process 0 \
