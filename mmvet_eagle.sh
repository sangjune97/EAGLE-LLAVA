...
python -m model_vqa_eagle \
    ...
    --ea-model-path /data/sangjun/ckpt/token/finetune_w_img_1e-4_100_layer2/state_20 \
    ...
    --answers-file /data/sangjun/ckpt/token/finetune_w_img_1e-4_100_layer2/state_20/mmvet.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
    --token-process 5 \
    --num_img_tok 100 \
