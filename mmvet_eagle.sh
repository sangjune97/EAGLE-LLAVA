...
python -m model_vqa_eagle \
    ...
    --ea-model-path /home/sangjun/EAGLE-LLAVA/ckpt/finetune_w_first_img_5e-5/state_40 \
    ...
    --answers-file /home/sangjun/EAGLE-LLAVA/ckpt/finetune_w_first_img_5e-5/state_40/test.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
    --token-process 3 \
