...
python -m model_vqa_eagle \
    ...
    --ea-model-path /home/sangjun/EAGLE-LLAVA/ckpt/not_finetune_w_img_1e-4_13b_only_embd/state_20 \
    ...
    --answers-file /home/sangjun/EAGLE-LLAVA/ckpt/not_finetune_w_img_1e-4_13b_only_embd/state_20.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
    --token-process 0 \
