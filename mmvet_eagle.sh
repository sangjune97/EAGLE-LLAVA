...
python -m model_vqa_eagle \
    ...
    --ea-model-path //home/sangjun/EAGLE-LLAVA/ckpt/finetune_wo_img_5e-5/state_40 \
    ...
    --answers-file /home/sangjun/EAGLE-LLAVA/ckpt/finetune_wo_img_5e-5/state_40/test_wo_img.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1
